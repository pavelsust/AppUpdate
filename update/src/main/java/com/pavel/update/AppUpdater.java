...
import com.pavel.update.enums.AppUpdaterError;
import com.pavel.update.enums.Display;
import com.pavel.update.enums.Duration;
import com.pavel.update.enums.UpdateFrom;
import com.pavel.update.interfaces.IAppUpdater;
import com.pavel.update.interfaces.UpdateListeners;
import com.pavel.update.objects.GitHub;
import com.pavel.update.objects.Update;
...
public class AppUpdater implements IAppUpdater {
    ...
    public void start(UpdateListeners updateListeners) {
        latestAppVersion = new UtilsAsync.LatestAppVersion(context, false, updateFrom, gitHub, xmlOrJsonUrl, new LibraryListener() {
            ...
            public void onSuccess(Update update) {
                ...
                updateListeners.onUpdate(UtilsLibrary.isUpdateAvailable(installedUpdate , update));
            }

            @Override
            public void onFailed(AppUpdaterError error) {
                updateListeners.onUpdate(false);
